...
public class TestCases {
	...
	public void  queSePuedaCrearUnTren() {
		...
		assertEquals((Integer) 250, nuevo.getCantidadDePasajeros());
	...
	@Test (expected = ColitionException.class)// Esta anotación se coloca sobre un método de prueba (como el que tienes en tu código). Indica que la prueba se considera exitosa si lanza una excepción del tipo ColitionException
	public void  queChoquenDosVehiculos() throws ColitionException {	//throws ColitionException: Esto se usa en la firma de un método para indicar que el método puede lanzar una excepción de tipo ColitionException
